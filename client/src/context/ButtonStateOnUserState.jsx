...
export const ButtonStateOnUserStateContext = createContext();

export const ButtonStateOnUserStateProvider = ({ children }) => {
    ...
    return(
        <ButtonStateOnUserStateContext.Provider value={{ state, setState }}>
            {children}
        </ButtonStateOnUserStateContext.Provider>
    )
};