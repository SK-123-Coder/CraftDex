...
import Tools_Data from "../data/For_DocumentationPage/Tools_Data/Tools.DocsContentData"
import Products_Data from "../data/For_DocumentationPage/Products_Data/Products.DocsContentData"
...
function DocsContent() {
  ...
  return (
    <>
      ...
      <section className="relative bg-gradient-to-b from-gray-950 via-gray-900 to-black text-white py-16 sm:py-20 lg:py-28">
        ...
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h3 className="text-base sm:text-lg lg:text-xl font-semibold mb-3 sm:mb-4 flex items-center gap-2">
              <span className="h-2 w-2 rounded-full bg-[#5FBFF9] shrink-0" />
              Overview
            </h3>
          ...
          {doc.features && (
            <div className="mb-12 sm:mb-16 lg:mb-24">
              ...
              <h3 className="text-base sm:text-lg lg:text-xl font-semibold mb-5 sm:mb-8 lg:mb-10 flex items-center gap-2">
                <span className="h-2 w-2 rounded-full bg-[#5FBFF9] shrink-0" />
                Features
              </h3>

              <ul className="grid grid-cols-1 xs:grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-5 lg:gap-6">
                {doc.features.map((feature, i) => (
                  <li
                    ...
                    className="
                      ...
                      text-xs sm:text-sm lg:text-base text-gray-300
          ...
          {doc.HTU && (
            <div
              ...
              "
            >
              <h3 className="text-base sm:text-lg lg:text-xl font-semibold mb-5 sm:mb-6 lg:mb-8 flex items-center gap-2">
                <span className="h-2 w-2 rounded-full bg-[#5FBFF9] shrink-0" />
                How to Use
              </h3>
              ...
              <ol className="space-y-3 sm:space-y-4">
                {doc.HTU.map((step, i) => (
                  ...
                  >
                    <span className="text-[#5FBFF9] font-semibold shrink-0 mt-0.5">
                      {i + 1}.
                    </span>
                    <span>{step}</span>
                  </li>
